...
material_parameters = {
    ...
    'CoatedElastic': ({'name': 'coated_test', 'coating_properties': {'E': 100e9, 'v': 0.3}, 'thickness': 0.02,
                      ...
                      {'grid_spacing': 0.01, '_directions': 'z', '_zero_mean': True},
                      {'grid_spacing': 0.01, 'tol': 1e-9}),
    'MultiLayerElastic': ({'name': 'multilayer_test',
                           'layers': [({'E': 100e9, 'v': 0.3}, 0.01), ({'E': 150e9, 'v': 0.25}, 0.02)],
                           'substrate_properties': {'E': 200e9, 'v': 0.3}},
                          {'grid_spacing': 0.01, '_directions': 'z', '_zero_mean': True},
                          {'grid_spacing': 0.01, 'tol': 1e-9}),
    'GradedCoatedElastic': ({'name': 'graded_coated_test', 'modulus_function': lambda z: 100e9 + 5e12 * z,
                             'p_ratio': 0.3, 'thickness': 0.02, 'substrate_properties': {'E': 200e9, 'v': 0.3},
                             'n_sublayers': 5},
                            {'grid_spacing': 0.01, '_directions': 'z', '_zero_mean': True},
                            {'grid_spacing': 0.01, 'tol': 1e-9}),
