...
class DiscFreqSurface(_AnalyticalSurface):
    ...
    This surface produces a profile with frquency componets which are constant in th y direction,
    these can be rotated and combined by addition or subtraction to give any combinaiton of frequencies.
