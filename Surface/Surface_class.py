...
class Surface(object):
    ...
    def __init__(self, **kwargs):
        ...
        if 'file_name' in kwargs:
            ...
            if ext == 'pkl':
                raise NotImplementedError("Saving and loading are not implemented yet")
    ...
    def _init_checks(self, kwargs: dict = False):
    ...
    @staticmethod
    def _get_points_from_extent(extent, grid_spacing):
